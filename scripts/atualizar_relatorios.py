...
def main():
    ...
    estrategia = f"""# Aplicação estratégica — revisão científica
...
"""
    ...
    escrever("reports/revisao_cientifica.md", """# Revisão científica e correções
...
""")
    ...
    escrever("reports/documentacao_tecnica.md", """# Documentação técnica — versão revisada
...
""")
    ...
    escrever("reports/roteiro_video.md", f"""# Roteiro executivo — versão revisada
